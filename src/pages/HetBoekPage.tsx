...
import goodreadsLogo from "../assets/goodreadslogo.png";
...
export function HetBoekPage() {
  return (
    <div className="book-page">
      ...
      <div className="goodreads-banner">
        <img src={goodreadsLogo} alt="Goodreads" className="goodreads-logo" />
        <span className="goodreads-copy">Laat een beoordeling achter op Goodreads!</span>
        <a
          href="https://www.goodreads.com/book/show/251580502-de-waterman"
          target="_blank"
