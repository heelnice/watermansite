...
const BEER_PRICES: { year: number; price: number }[] = [
  { year: 2015, price: 2.70 },
  { year: 2016, price: 2.76 },
  { year: 2017, price: 2.85 },
  { year: 2018, price: 2.94 },
  { year: 2019, price: 3.06 },
  { year: 2020, price: 3.12 },
  { year: 2021, price: 3.21 },
  { year: 2022, price: 3.45 },  // inflatiesprong
  { year: 2023, price: 3.57 },
  { year: 2024, price: 3.60 },
  { year: 2025, price: 3.63 },
...
function BeerChart() {
  ...
  const gridY = [2.7, 3.0, 3.3, 3.6, 3.7];
      ...
      <section className="koop-product">
        <div className="koop-product-grid">
          ...
          <div className="koop-product-info-col">
            ...
            {edition === "epub" && (
              <>
                <div className="koop-price">€3,69</div>
                <p className="koop-availability">Een e-Pub is eigenlijk een digitale kroeg. Daarom is deze altijd gelijk aan de gemiddelde prijs van een vaasje bier (0,3L) in Nederland.*</p>
        ...
        {edition === "epub" && (
          <div className="koop-below-columns">
            ...
            <div className="beer-tracker-standalone">
              <div className="beer-tracker-title">*Prijstracker vaasje 0,3L bier (NL gem.)</div>
